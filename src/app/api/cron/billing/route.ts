 ...
 * for companies that turned them on. A Netlify scheduled function runs it
 * daily (netlify/functions/cron-billing.mts); any other scheduler can call it with
...
// Some schedulers call with GET (and the same Bearer CRON_SECRET header).
